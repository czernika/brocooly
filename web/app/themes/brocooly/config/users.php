...
return [
	 ...
	 *
	 * NOTE: New role will be available after theme switching and will NOT be removed if ypur comment or remove this line in this section. However it is will not be available in other themes. Please use `remove_role()` to erase it from database.
	 *
